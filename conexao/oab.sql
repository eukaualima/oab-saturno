...
CREATE TABLE provas (codigo BIGINT PRIMARY KEY AUTO_INCREMENT, discord_id VARCHAR(255), nome VARCHAR(255), passaporte VARCHAR(255), numero VARCHAR(255), idade VARCHAR(255), resposta_1 MEDIUMTEXT, resposta_2 MEDIUMTEXT, resposta_3 MEDIUMTEXT, resposta_4 MEDIUMTEXT, resposta_5 MEDIUMTEXT, resposta_6 MEDIUMTEXT, resposta_7 MEDIUMTEXT, resposta_8 MEDIUMTEXT, resposta_9 MEDIUMTEXT, resposta_10 MEDIUMTEXT, resposta_11 MEDIUMTEXT, resposta_12 MEDIUMTEXT, resposta_13 MEDIUMTEXT, resposta_14 MEDIUMTEXT, resultado MEDIUMTEXT, juiz MEDIUMTEXT);