...
module.exports = 
{
	...
	data: new SlashCommandBuilder()
        .setName("promover")
        .setDescription("Promove um(a) advogado(a) para Promotor(a) ou Juiz(a).")
	...
	async execute(interaction, client) 
    {
        ...
        {
            return interaction.reply({ content: `<:oab_error:1187428311014576208> **|** ${usuario} **não é um(a) Advogado(a)**. Utilize o comando \`/cadv\`.`, ephemeral: true });
        }
