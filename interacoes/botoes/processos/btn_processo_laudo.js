...
module.exports = 
{
	...
	async execute(interaction, client) 
    {
        ...
        pool.query(`SELECT * FROM adocoes WHERE codigo = ${codigo}`, async function (erro, adocoes)
        {
            ...
            await interaction.channel.send({ content: `## <:oab_laudo:1208873105368555571> Laudo Médico\nPrezado(a) Dr(a). <@${adocoes[0].advogado}>, aguarda-se a **juntada do laudo médico** para designação de nova audiência com **oitiva de testemunhas**.\n` });
        })
    },
};