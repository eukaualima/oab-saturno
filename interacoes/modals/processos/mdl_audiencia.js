            ...
            pool.query(`SELECT * FROM servidores WHERE discord_id = ${interaction.user.id}`, async function (erro, servidores)
            {
                ...
                interaction.guild.channels.create(
                    ...
                    }).then(canal => 
                    {
                        ...
                        interaction.reply({ content: `<:oab_check:1187428122988126348> **|** Processo de Audiência Nº${total_registros+1} aberto com sucesso! Acesso-o no canal <#${canal.id}>.`, ephemeral: true });
                    })
            })
        })
    },
