...
module.exports = 
{
	...
	async execute(interaction, client) 
    {
        ...
        interaction.update({ content: `## <:oab_questao:1204999334853214260> Questão 2.1\n> O advogado(a) pode ter condutas desrespeitosas como LGBTfobia, Racismo ou Xenofobia com um cliente ou outro colega de trabalho (ou quaisquer players)?\n> **Resposta:** ${resposta}.`, components: [] });

        // < Registra a última resposta >
        pool.query(`UPDATE provas SET resposta_7 = '${resposta}'`);

        // < Respostas >
        const select = new StringSelectMenuBuilder()
        .setCustomId('slc_prova_questao_22')
        ...
        // < Informe >
        await interaction.channel.send({ content: `<:oab_relogio:1204997699586236436> **|** ${interaction.member}, questão 2.2 em **5 segundos**...` });

        // < Pergunta #1 >
        setTimeout(async () => {
            // < Pergunta #1 >
            await interaction.channel.send({ content: `## <:oab_questao:1204999334853214260> Questão 2.2\n> É permitido assaltar / sequestrar / roubar / sacar arma / matar / abordar em áreas safes?`, components: [row] });
        }, 5000);
    },
};