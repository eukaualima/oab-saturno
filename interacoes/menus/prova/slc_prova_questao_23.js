...
module.exports = 
{
	...
	async execute(interaction, client) 
    {
        ...
        interaction.update({ content: `## <:oab_questao:1204999334853214260> Questão 2.3\n> O réu tem garantia de defesa independente do crime cometido?\n> **Resposta:** ${resposta}.`, components: [] });
        ...
        .setCustomId('slc_prova_questao_24')
        ...
        // < Informe >
        await interaction.channel.send({ content: `<:oab_relogio:1204997699586236436> **|** ${interaction.member}, questão 2.4 em **5 segundos**...` });

        // < Pergunta #1 >
        setTimeout(async () => {
            // < Pergunta #1 >
            await interaction.channel.send({ content: `## <:oab_questao:1204999334853214260> Questão 2.4\n> Na advocacia, é permitido o uso ou comercialização de itens ilegais?`, components: [row] });
        }, 5000);
    },
};